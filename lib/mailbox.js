...
class Mailbox {
    ...
    async listMessages(options) {
        ...
        try {
            ...
            // for await (let messageObject of 
            //     messages.filter(m => m.plainTextParts && m.plainTextParts.length)
            //             .map(async m => {
            //     const messageData = await this.imapClient.download(m.uid, m.plainTextParts[0], {
            //         uid: true,
            //     });
            ...
            //     const { messageData, message } = messageObject;
            //     const { meta, content } = messageData;
            ...
            //     })
            //     message.text.plain = plainText.replace(/\r?\n/g, '\n');
            // }
